...
begin
 ...
 begin
  Reset;
  AddText(0.0,pvApplication.Height-(fFontCharHeight*1.0),1.0,toaLeft,TpvApplicationRawByteString('Device: '+pvApplication.VulkanDevice.PhysicalDevice.DeviceName{$ifdef Android}+' ('+TpvApplicationRawByteString(AndroidDeviceName)+')'{$endif}));
